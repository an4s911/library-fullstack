        ...
        <main className="w-full h-full overflow-y-auto gap-4 md:gap-8 md:px-20 flex flex-col md:grid md:grid-cols-[250px_1fr]">
            ...
            >
                ...
                >
                    ...
                    {isFilterOpen ? (
                        <ChevronUpIcon size={20} className="ml-auto text-primary" />
                    ) : (
                        <ChevronDownIcon size={20} className="ml-auto text-primary" />
                    )}
                </div>
            ...
            <div className="flex flex-col gap-5 mt-4 md:mt-8 w-full md:w-auto">
                <div
                    className="w-full pb-2 flex flex-wrap md:flex-nowrap items-center
                    justify-between sticky top-0 md:top-8 z-10 gap-4 bg-primary-100/90 dark:bg-primary-900/90
                    p-2 md:rounded-b-md backdrop-blur-sm"
                >
                    <SortSection />
                    <div className="flex items-center gap-4 w-full justify-center md:ml-0 md:w-auto">
                        <PageNav />
                        <LayoutToggleBtn
                            isGrid={isGrid}
