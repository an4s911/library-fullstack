        ...
        <div className="flex gap-2">
            <div className="search-field flex-1 relative">
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg dark:bg-gray-700 dark:text-white dark:placeholder-gray-400
            ...
            <select
                ...
                className="px-3 py-2 rounded-lg dark:bg-gray-700 dark:text-white dark:border-gray-600
